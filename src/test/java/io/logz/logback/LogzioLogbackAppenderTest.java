...
public class LogzioLogbackAppenderTest extends BaseLogbackAppenderTest {
    ...
    public void checkExactStackTrace() throws Exception {
        ...
        String expectedExceptionStart = "java.lang.RuntimeException: Got NPE!\n" +
        ...
        String expectedExceptionEnd = "Caused by: java.lang.NullPointerException: null\n" +
        ...
        MockLogzioBulkListener.LogRequest logRequest = mockListener.assertLogReceivedByMessage(message1);
        mockListener.assertLogReceivedIs(logRequest, token, type, loggerName, Level.INFO.levelStr);
        String actualException = logRequest.getStringFieldOrNull("exception");
        assertThat(actualException).startsWith(expectedExceptionStart);
        assertThat(actualException).endsWith(expectedExceptionEnd);
    }
