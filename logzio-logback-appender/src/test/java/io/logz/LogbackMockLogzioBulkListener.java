...
public class LogbackMockLogzioBulkListener implements Closeable {
    private final static Logger logger = LoggerFactory.getLogger(LogbackMockLogzioBulkListener.class);
    ...
    public LogbackMockLogzioBulkListener(String host, int port) {
        this.host = host;
        this.port = port;
    ...
    public void start() throws Exception {
        logger.info("Starting LogbackMockLogzioBulkListener");
        server.start();
        int attempts = 1;
